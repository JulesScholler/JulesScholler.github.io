...
Here are some videos (links) of our results shown on the poster. **If you want to obtain original files without watermark for a presentation or a course, feel free to leave a comment or send a mail (click on the mail icon in the footer)**.
